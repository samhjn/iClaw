...
final class ContextManager {
    ...
    private func convertWithImageForwarding(_ msgs: [Message]) -> [LLMChatMessage] {
        ...
        for msg in msgs {
            ...
            case .user:
                ...
                if let imgData = msg.imageAttachmentsData,
                   ...
                   !decoded.isEmpty {
                    allImages.append(contentsOf: decoded)
                }
        ...
        // Flush any remaining pending images (e.g. from assistant messages
        // with no subsequent user message) as a synthetic user turn so the
        // LLM can still see them.
